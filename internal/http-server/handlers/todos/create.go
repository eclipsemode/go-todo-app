...
//func New(ctx *gin.Context, log *slog.Logger, todoService TodoService) http.HandlerFunc {
...
//		}
//
//		_, err := todoService.CreateTodo(req.Title, req.Description)
//		if errors.Is(err, storage.ErrAlreadyExists) {
//			log.Error("todo already exists", sl.Err(err))
//
//			ctx.IndentedJSON(http.StatusInternalServerError, responseApi.Error("todo already exists"))
...
//		}
//
//		log.Info("todo successfully created", slog.String("title", req.Title),
